...
provider wins without submitting inference during the race. The SDK preserves
that provider's origin and worker count and then submits the PDF exactly once.
